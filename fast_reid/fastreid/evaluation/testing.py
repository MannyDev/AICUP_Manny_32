...
import pprint
import sys
from collections.abc import Mapping as mapping  # Import collections.abc for Python 3.10+

if sys.version_info >= (3, 10):
  Mapping = mapping  # Use collections.abc.Mapping for Python 3.10+
else:
  Mapping = collections.Mapping  # Use collections.Mapping for older versions
